...
module.exports = require('./src/heart')

},{"./src/heart":149}],2:[function(require,module,exports){
...
var Heart = module.exports = React.createClass({displayName: "exports",
    propTypes: {
  ...
  , render: function(){
    var author = this.props.author ?
          React.createElement(Author, {link: this.props.author.link}, this.props.author.name)
          : null
    var authors = this.props.authors ?
          React.createElement(Authors, {list: this.props.authors}) 
          : null

    return (
      React.createElement("p", {className: "hrt"}, 
        React.createElement(Word, null, this.props.made), 
          "with", 
        React.createElement(Icon, {animation: this.props.animation}, this.props.heart), 
        author || authors
      )
    )
  }
...
var Word = React.createClass({displayName: "Word",
  ...
  render: function(){
    return (
      React.createElement("span", {className: "hrt_made"}, this.props.children)
    )
  }
})
...
var Icon = React.createClass({displayName: "Icon",
  ...
  render: function(){
    ...
    return (
      React.createElement("span", {className: _class}, this.props.children)
    )
  }
})
...
var Author = React.createClass({displayName: "Author",
  ...
  render: function(){
    return (
      React.createElement("span", {className: "hrt_author"}, "by", 
...
var Authors = React.createClass({displayName: "Authors",
  render: function(){
    ...
    var authors = this.props.list.reduce(function(acc, a, i, list){
      if(i == numOfAuthors - 1)
        return acc.concat(
          React.createElement("span", null, "and ", React.createElement("a", {href: a.link}, a.name))
        )
      else if(i == 0) return acc.concat(React.createElement("a", {href: a.link}, a.name))
      else return acc.concat(React.createElement("span", null, ", ", React.createElement("a", {href: a.link}, a.name)))
    }, [])
